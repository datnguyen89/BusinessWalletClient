...
const ICONS = {
  ...
  CONFIRMED_ICON: require('./media/icons/confirmed.svg'),
  ...
  USER_APPROVED: require('./media/icons/user-approved.svg'),
  USER_REJECTED: require('./media/icons/user-rejected.svg'),
