...
class MobileNetworkOperatorStore {
  ...
  @action getMobileNetworkOperators = () => {
    return new Promise((resolve, reject) => {
      this.mobileNetworkOperators = [
        { id: 1, imageUrl: require('../media/images/mobifone.png'), name: 'Mobifone' },
        { id: 2, imageUrl: require('../media/images/mobifone.png'), name: 'Vinaphone' },
        { id: 3, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
        { id: 4, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
        { id: 5, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
        { id: 6, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
        { id: 7, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
        { id: 8, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
      ];
    })
  }
  ...
  @action getServicePlanMobile = () => {
    return new Promise((resolve, reject) => {
      this.mobileNetworkOperators = [
        { id: 1, imageUrl: require('../media/images/mobifone.png'), name: 'Mobifone' },
        { id: 2, imageUrl: require('../media/images/vinaphone.png'), name: 'Vinaphone' },
        { id: 3, imageUrl: require('../media/images/viettel.png'), name: 'Viettel' },
        { id: 4, imageUrl: require('../media/images/vietnamobile.png'), name: 'Vietnamobile' },
        { id: 5, imageUrl: require('../media/images/g_mobile.png'), name: 'GMobile' },
        { id: 6, imageUrl: require('../media/images/indochina.png'), name: 'IndochinaTelecom' },
        { id: 7, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
        { id: 8, imageUrl: require('../media/images/mobifone.png'), name: 'Viettel' },
      ];
    })
