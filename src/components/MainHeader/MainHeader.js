...
const MainHeader = props => {
  ...
  console.log('ICONS.DEPOSIT_ICON', ICONS.DEPOSIT_ICON)
      ...
      <MainHeaderRight>
        <HeaderTransactionArea>
          <HeaderTransactionItem>
            ...
            <Icon component={ICONS.DEPOSIT_ICON} />
            <CustomLink activeClassName={pageName === 'deposit' ? 'selected' : ''} to='/deposit'><span>Nạp tiền</span></CustomLink>
          </HeaderTransactionItem>
          <HeaderTransactionItem>
            <img src={ICONS.TRANSFER_ICON} alt={''} />
            <CustomLink activeClassName={pageName === 'tranfer' ? 'selected' : ''} to='/tranfer'><span>Chuyển tiền</span></CustomLink>
          </HeaderTransactionItem>
          <HeaderTransactionItem>
          ...
          <HeaderTransactionItem>
            ...
            <CustomLink activeClassName={pageName === 'withdraw' ? 'selected' : ''} to='/withdraw'><span>Rút tiền</span></CustomLink>
          </HeaderTransactionItem>
        </HeaderTransactionArea>
        <HeaderNotifyArea>
          <NotifyBell />
